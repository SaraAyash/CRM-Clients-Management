...
export default connect(mapStateToProps, mapDispatchToProps)(function CalcApr(props) {
    ...
    const [score, setScore] = useState({ property: 'Apartment in a building', city: '', street: '', numberHouse: '', yearsOld: 0, area: 0, livers: 0, firstName: '', lastName: '', id: '' });
    ...
    // property: 'Apartment in a building',city:'',street:'', numberHouse:'', yearsOld:0, area:0, livers:0, firstName:'', lastName:'',id:'' });
                ...
                <Form>
                    ...
                    {moreHomeDetails ?
                        <>
                            ...
                            <Form.Label>And some tenants live in it</Form.Label>
                            <Form.Group as={Col} >
                                <Form.Control
                                    min="0" type="number"
                                    onChange={(e) => setScore({ ...score, livers: e.target.value })} />
                            </Form.Group>

                            <Form.Label>Do you have a mortgage on the house?</Form.Label>
                            <Form.Group as={Col} >
